...
export default function MobileNav() {
  ...
  return (
    <>
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            width: 30, height: 22, display: 'inline-flex', flexDirection: 'column',
            justifyContent: 'center', gap: 3, border: 'none', background: 'transparent', padding: 0,
          }}
        >
      ...
      >
        <div className="panel" style={{ position: 'absolute', inset: 0, background: 'var(--menu-bg, #00AEEF)' }}>
          <div
          ...
          >
            ...
            <button
              ...
              style={{ position: 'absolute', top: insetPanel, right: insetPanel, fontSize: 28, lineHeight: 1, background: 'transparent', border: 'none', padding: 0, color: '#fff' }}
            >
              ×
            </button>
          </div>
